...
function getLodop(oOBJECT, oEMBED) {
    ...
    var strCLodopInstall_2 = "<br>（若此前已安装过，可<a href='lodop/CLodop.protocol:setup' target='_self'>点这里直接再次启动</a>）";
    ...
    try {
        ...
        LODOP.SET_LICENSES("上海危网信息科技有限公司","E61623898EE17DEFD036D1E8A683CA26","","");
        //=======================================================
        return LODOP;
    } catch (err) {
