 ...
 * @application name：
 * @author: zhouxinlei
 * @time：2018年10月19日 @version：ver 1.1
 */
public class PerControlFilter extends AccessControlFilter {
    ...
    public void setCacheManager(RedisCacheManager cacheManager) {
        this.cache = cacheManager.getCache(RedisConstant.shiro_redis_session);
    }
